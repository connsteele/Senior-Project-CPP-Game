...
public:
	...
	void outOfSight(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex);

	
	// Combat Stat Related Variables
	bool isMoveable; // Movement Boolean
	UPROPERTY(BlueprintReadWrite, EditAnywhere)
		bool isMoving; // Used for animation statemachine
